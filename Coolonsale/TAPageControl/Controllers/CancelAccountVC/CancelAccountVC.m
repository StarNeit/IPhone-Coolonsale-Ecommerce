...
@implementation CancelAccountVC
...
- (IBAction)clickCancelAccount:(id)sender {
    [Common showAlert:@"Cancel Account"];
}
- (IBAction)clickWillStayButton:(id)sender {
    [Common showAlert:@"Will Stay"];
}
